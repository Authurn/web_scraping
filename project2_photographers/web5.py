...
url = "https://ukbusinessportal.co.uk/category/photographers/"
...
df.to_csv("photographers_companies.csv", index=False)

print("Data saved to photographers_companies.csv")
